...
const EventsDetails = () => {
  ...
  const { name, description, image , category, date , organizer, location, price} = event;
  ...
  return (
    <div className="container flex md:flex-row flex-col w-full m-10 justify-evenly w-full gap-5">
      ...
      <div className="conatiner w-full h-auto flex flex-col items-end py-4 px-30 justify-end mr-5">
