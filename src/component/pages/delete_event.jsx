  ...
  return (
    <div className="w-full">
      ...
      <div className=" flex flex-wrap justify-center gap-10">
        {event.map((elements) => (
          <div key={elements.id} className="max-w-sm h-min bg-white border border-gray-200 rounded-lg shadow-md">
            <a href=".">
              <img className="rounded-t-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="" />
            </a>
            <div className="p-5">
              <a href=".">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">{elements.name}</h5>
              </a>
              <p className="mb-3 font-normal text-gray-700">{elements.description}</p>
              <button onClick={submitHandler} type="button" value={elements.id} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                Delete Event
